...
namespace SecuruStikSettings
{
    ...
    public static class AppSetting
    {
        ...
        public static String Desktop =  Environment.GetFolderPath( Environment.SpecialFolder.CommonDesktopDirectory );
        ...
        public static String Name_Downloader = "Downloader.exe";
        ...
        public static String App_ShellExtension_Sharpdll = Path.GetFullPath( "./SharpShell.dll" );
        ...
        public static String AppDataFolder_DownloaderFullPath = Path.Combine( AppSetting.ApplicationData_SecuruStikPath , Name_Downloader );
        public static String AppDatafolder_Icon = Path.Combine( AppSetting.ApplicationData_SecuruStikPath , Name_AppIconFile );
