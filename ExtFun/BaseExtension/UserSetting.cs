...
namespace SecuruStik.BaseExtension
{
    ...
    public static class AppSetting
    {
        ...
        public static String IconPath = Path.GetFullPath( "./Icon/appicon.ico" );
        #endregion App path
        ...
        public static String ShellExtensionsFullPath = Path.Combine( AppSetting.ApplicationData_SecuruStikPath, "ShellExtensions.dll" );
